...
public class SweepConstraintExample1 {
    public void testForbiddenRegion() {
        ...
        TwinMoreOrEqual C = new TwinMoreOrEqual(x, y, 1, 2, 6);
        ...
        if(printForbidden){
            System.out.println("Forbiden regions of AbsoluteAboveEqualVarSub:");
            List<ForbiddenRegion> forbiddenRegionsAbs = B.getForbiddenRegions();
            System.out.println(forbiddenRegionsAbs);
            System.out.println();

            System.out.println("Forbiden regions of AllDifferentVar:");
            List<ForbiddenRegion> forbiddenRegionsAllDiff = A.getForbiddenRegions();
            System.out.println(forbiddenRegionsAllDiff);
            System.out.println();

            System.out.println("Forbiden regions of TwinLessOrEqual:");
            List<ForbiddenRegion> forbiddenRegionsTwinLE = C.getForbiddenRegions();
            System.out.println(forbiddenRegionsTwinLE);
            System.out.println();

            System.out.println("Forbiden regions of TwinMod:");
            List<ForbiddenRegion> forbiddenRegionsTwinMod = E.getForbiddenRegions();    
            System.out.println(forbiddenRegionsTwinMod);
            System.out.println();
        }
